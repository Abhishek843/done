...
async function addExpense() {
  try {
    ...
    const res = await axios.post(
      "http://35.153.73.136:3200/expense/addExpense",
      {
        date: dateStr,
...
async function getAllExpenses() {
  try {
    ...
    const res = await axios.get(
      "http://35.153.73.136:3200/expense/getAllExpenses/1",
      { headers: { Authorization: token } }
    );
...
async function deleteExpense(e) {
  try {
    ...
    if (e.target.classList.contains("delete")) {
      ...
      const res = await axios.get(
        `http://35.153.73.136:3200/expense/deleteExpense/${id}`,
        { headers: { Authorization: token } }
      );
...
async function editExpense(e) {
  try {
    ...
    if (e.target.classList.contains("edit")) {
      ...
      // Send a GET request to retrieve all expenses
      const res = await axios.get(
        "http://35.153.73.136:3200/expense/getAllExpenses",
        { headers: { Authorization: token } }
      );
      ...
      res.data.forEach((expense) => {
        if (expense.id == id) {
          ...
          addExpenseBtn.addEventListener("click", async function update(e) {
            ...
            const res = await axios.post(
              `http://35.153.73.136:3200/expense/editExpense/${id}`,
              {
...
async function buyPremium(e) {
  ...
  const res = await axios.get(
    "http://35.153.73.136:3200/purchase/premiumMembership",
    { headers: { Authorization: token } }
  );
  ...
  var options = {
    ...
    handler: async function (response) {
      const res = await axios.post(
        "http://35.153.73.136:3200/purchase/updateTransactionStatus",
        {
...
async function isPremiumUser() {
  ...
  const res = await axios.get("http://35.153.73.136:3200/isPremiumUser", {
    headers: { Authorization: token },
  });
...
async function paginationBtn(e) {
  try {
    ...
    const res = await axios.get(
      `http://35.153.73.136:3200/expense/getAllExpenses/${pageNo}`,
      { headers: { Authorization: token } }
    );
